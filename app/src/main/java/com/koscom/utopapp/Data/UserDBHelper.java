...
public class UserDBHelper extends SQLiteOpenHelper {
    ...
    public long insertUser(com.koscom.utopapp.Data.UserBean user){
    ...
    public ArrayList<com.koscom.utopapp.Data.UserBean> getAllUser(){
        SQLiteDatabase db = getReadableDatabase();
        Cursor cursor = db.query(TABLE_NAME, null, null, null, null, null, null);
        ArrayList<com.koscom.utopapp.Data.UserBean> result = new ArrayList<>();

        while(cursor.moveToNext()){
            com.koscom.utopapp.Data.UserBean user = new com.koscom.utopapp.Data.UserBean();
    ...
    public ArrayList<com.koscom.utopapp.Data.UserBean> getUserById(String id){
        SQLiteDatabase db = getReadableDatabase();
    ...
    public long deleteUser(com.koscom.utopapp.Data.UserBean bean){
        SQLiteDatabase db = getWritableDatabase();
